...
<body>
    ...
    <div class="container">
        ...
        <p>O index é a home do site, Ele tem o header na qual é possivel navegar pelo site inteiro, no quesito de php foi utilizado uma aba para estilizar o site conforme a paleta de cores de 2 séries: Game of thrones e breaking bad<br>
            utilizando session com um switch que muda o nome da cor conforme a variavel "opcao" é escolhida.<br>Logo gerado por inteligencia artifical  </p>
        ...
        <p>Utilizamos no que contempla quase o site todo 2 varíaveis sessions. <br>
            ...
            <br><br><br> Membros do grupo: <a target="blank" href="https://www.linkedin.com/in/ronan-camilo-gomes-558280202/"> Ronan Camilo Gomes </a>(responsavel por toda a parte PHP e Html do site)<br>Daniel Macario De Jesus(Html e Css) <br> João Vyctor Prudêncio Vieira Lima
        </p>
