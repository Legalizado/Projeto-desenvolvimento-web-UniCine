...
<section>
    ...
    <div class="SectionContainer">
        <div class="direita">
            ...
            <h1 id="tituloComeco">Bem vindo ao UniCine!</h1><br>

        <div class="textoprincipal">
            <p> <img class="logo" src="Logo"> Ficamos feliz em visitar a  nossa página <?php if(isset($_SESSION["usuarioRegistro"])){echo $_SESSION["usuarioRegistro"];}else{ echo"";} ?> ,no unicine, reunimos as melhores séries do mundo e as classificamos uma a uma.
                Nosso objetivo é proporcionar a você uma experiência incrível, para que possa desfrutar do melhor 
                conteúdo da sétima arte, seja durante o dia ou à noite. </p>
        </div>
        <div class="containerstreamings">
       
        <p id="tituloStreamings"><strong>Os melhores streamings voce encontra aqui em baixo:</strong></p>
...
<!-- Colocar selected para cada item parar tirar o padrao--> <?php if($_SESSION['opcao'] == 'breakingbad')
{ echo "<option selected value='breakingbad'>Breaking Bad</option>";}else
{ echo "<option value='breakingbad'>Breaking Bad</option>}" ;};
           if($_SESSION['opcao'] == 'got'){ echo "<option selected value='got'>Game of Thrones</option>";}
           else{echo"<option value='got'>Game of Thrones</option>";}
